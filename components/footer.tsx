    ...
    <footer className="bg-foreground text-background">
      <div className="container mx-auto px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr_1fr] gap-8 md:gap-12 items-start">
            ...
            <div>
              ...
              {/* Divider Line */}
              <div className="border-t border-background/20 my-4"></div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-[#FD820A] font-medium leading-snug">
        ...
        {/* Bottom Copyright */}
        <div className="mt-10 pt-6 border-t border-background/10 text-center text-background/50 text-xs max-w-5xl mx-auto">
